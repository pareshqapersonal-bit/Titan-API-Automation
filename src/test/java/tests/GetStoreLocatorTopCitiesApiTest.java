...
import apis.GetStoreLocatorTopCitiesApi;
...
public class GetStoreLocatorTopCitiesApiTest extends BaseTest {
...
Response response;
	...
	GetStoreLocatorTopCitiesApi storeApi = new GetStoreLocatorTopCitiesApi();
	response = storeApi.getstorelocatortopCities(mobileSpec, pd, customerToken);
